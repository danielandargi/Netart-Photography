...
export default function WhatsAppButton({ siteSettings }: WhatsAppButtonProps) {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full ml-3 bg-foreground text-white text-sm px-3 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
        דברו איתנו בוואטסאפ
      </span>
    </a>
  );
