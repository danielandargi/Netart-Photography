...
import { contactInfo, services } from "@/lib/utils";
    ...
    <footer className="bg-foreground text-white py-16">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-white/70 leading-relaxed">
              צילום מקצועי שמנציח את הרגעים היפים בחייכם.
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-lg mb-4">שירותים</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-lg mb-4">יצירת קשר</h4>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-white/50 text-sm">
          <p>© {new Date().getFullYear()} NetArt. כל הזכויות שמורות.</p>
        </div>
      </div>
    </footer>
  );
